    ...
    def test_Contract_Master(self):
        ...
        if self.switch_frames("btn_NewRecord"):
            ...
            # Basic Information
                ...
                self.autocomplete_select(By.ID, "ContractLocationId-select", "Head Office")
                self.send_keys(By.ID, "FromDate", "06-06-2024")
                self.send_keys(By.ID, "ToDate", "06-06-2025")
                ...
                series = [{"Rate": "700", "MinimumValue": "700", "FromLocation": "BHIWANDI"},
                          {"Rate": "800", "MinimumValue": "800", "FromLocation": "DELHI"}]
                ...
                for i in series:
                    ...
                    if self.switch_frames("FreightOnId"):
                        ...
                        self.select_dropdown(By.ID, "LocationBasisId", "Location")
